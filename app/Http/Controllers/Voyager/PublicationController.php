...
class PublicationController extends VoyagerBaseController
{
    ...
    public function import($scholar_id)
    {
        $query = [
        ...
        foreach($result->articles as $scholar){
            Publication::updateOrCreate(
            [
                'cited_by_cites_id' => $scholar->cited_by->cites_id
            ],
            [
                'author_id' => $scholar_id,
                'title' => $scholar->title,
                'link' => $scholar->link,
                'citation_id' => $scholar->citation_id,
                'authors' => $scholar->authors,
                'publication' => $scholar->publication??'',
                'cited_by_value' => $scholar->cited_by->value,
                'cited_by_link' => $scholar->cited_by->link,
                'year' => $scholar->year,
